        ...
        <div class="panel-body">
            ...
            <form method="post" action="crud/<?php echo $tblName;?>_action.php" class="form" id="userForm">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" class="form-control" name="step" value="<?php echo $datas[$tbl]; ?>"/>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <label>Icon</label>
                    <input type="text" class="form-control input-add" name="pic" value="<?php echo $datas['pic']; ?>"/>
                </div>
                <div class="form-group">
                    <label>Color</label>
                    <input type="text" class="form-control input-add" name="color"  value="<?php echo $datas['color']; ?>"/>
                </div>
                    <div class="form-group">
                        <label>Active</label>
