...
<div id="myModal" class="modal" tabindex="-1" role="dialog" style="top:40px;background: rgba(0, 0, 0, 0.8);">
  <div class="modal-dialog" style="background: rgba(0, 0, 0, 0);border:0px;">
