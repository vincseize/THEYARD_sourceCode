...
<div class="section group" style="background: #555;padding-left:20px;">
	<span style="color: #bbb;float:left;left:20px;"><h1>Comments</h1></span>
...
<div style="position:relative;float:right;right:15px;">   
    <a  href="#collapse1"  class="nav-toggle" title="add comment" style="text-decoration:none;font-size:32px;color:#eee;">
