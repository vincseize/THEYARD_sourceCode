...
<?php 
    ...
    $vignette = ROOT_SHAMAN.$ds.DATASstoreFolderName.$ds.$ids_projects."_".$name_project.$ds."assets".$ds.$folder_name.$ds."vignette.jpg";
    $vignette_comp = ROOT_SHAMAN.$ds.DATASstoreFolderName.$ds.$ids_projects."_".$name_project.$ds."assets".$ds.$folder_name.$ds."vignette_comp.jpg";
/*
    echo DATASstoreFolderName;
    echo $ids_projects;
    echo $name_project;
    echo $folder_name;
    echo '<br>-----------------------<br>';*/
