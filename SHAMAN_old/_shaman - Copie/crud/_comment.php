...
<?php
 ...
 $DATAScommentsFolder = ROOT_SHAMAN.$ds.DATASstoreFolderName.$ds.$ids_projects."_".$name_project.$ds."assets".$ds.$folder_name.$ds."comments".$ds.$data5['timestamp_id_creator'].$ds;
...
*/
 ...
 $DATAScommentsFolder = ROOT_PATH.$ds.DATASstoreFolderName.$ds.$ids_projects."_".$name_project.$ds."assets".$ds.$folder_name.$ds."comments".$ds.$data5['timestamp_id_creator'].$ds;
// echo $DATAScommentsFolder;
...
/*      $directory = "";*/
      ...
      foreach($folder as $vignette){
              ...
              $vignette_path = ROOT_SHAMAN.$ds.'_shamanDATAS/_/assets/_123_TEST105/comments/20161110_110348_9/aX0xJpb.jpg'; // for javascript antislash
              $movie = 0;
              echo $vignette_path;
