        ...
        <div id="page-wrapper">
            ...
            <div class="row" id="row">
                <div class="panel panel-default projects-content">
                    <div class="panel-heading">Projects <a href="#" class="glyphicon glyphicon-plus" id="trigger_add"></a></div>
                    <table class="table">
                        <tr>
                            <th width="10px">#</th>
                        ...
                        if(!empty($datas)){ 
                            $count = 0; foreach($datas as $data){ 
                                $count++;
                                $checked = '';
                                $delete = "<a href=\"crud/archive_action.php?tblName=".$tblName."&action_type=archive&id=".$data['id']."\" class=\"glyphicon glyphicon-trash\" onclick=\"return confirm('Delete [ ".$data['project']." ] Project ?');\"></a>";
                        ...
                        <?php } }else{ ?>
                        <tr><td colspan="4">No project(s) found...</td>
                        <?php } ?>
                    </table>
                </div>
...
$(document).ready(function(){
    ...
    $('#trigger_add').click(function(e){
         e.preventDefault();
        $("#row").load("crud/projects_add.php");
      });
    // edit
    $("#trigger_edit[value]").click(function(e) {
        e.preventDefault();
        var id =   $(this).attr("value");
        $("#row").load("crud/projects_edit.php?id="+id);
    });
    //delete
