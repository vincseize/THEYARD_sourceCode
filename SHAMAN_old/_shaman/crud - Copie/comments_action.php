...
/*            $archived=1;
            ...
            if(!empty($_POST['id_comment']) && !empty($_POST['DATAScommentsFolder'])){
                $condition = array('id' => $_POST['id_comment']);
                $delete = $db->delete($tblName,$condition);
                $dirname = $_POST['DATAScommentsFolder'];
            ...
            if(!empty($_POST['path']) && !empty($_POST['path'])){
/*                $condition = array('id' => $_POST['id_comment']);
                $delete = $db->delete($tblName,$condition);
                $dirname = $_POST['DATAScommentsFolder'];
                $dir = $dirname.'/'; // IMPORTANT: with '/' at the end
                ...
                @unlink($_POST['path']);
/*                echo "delete ".$_POST['path']." OK";
                echo "delete ".$_POST['id_asset']." OK";*/
                header("Location:assets_edit.php?id=".$_POST['id_asset']."");
            }
    }
            ...
            echo "Failed";
            echo $_REQUEST['action_type'];echo $_REQUEST['id_comment'];
        }
